...
#ifdef __cplusplus
#define VEC_OP_DEF(type, type_name) \
...
#define VEC2_DEF(type, type_name) \
    ...
    type_name type_name##_negate(type_name vec);                      \
...
// TODO: optimize, and expand some calculations, instead of utilizing other functions
